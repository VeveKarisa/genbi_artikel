...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "UPDATE pendi SET nama_divisi='$nama_divisi', koor='$koor', sekre='$sekre', benda='$benda', anggota_satu='$anggota_satu', anggota_dua='$anggota_dua', anggota_tiga='$anggota_tiga', anggota_empat='$anggota_empat', anggota_lima='$anggota_lima', anggota_enam='$anggota_enam', img='$new_image_name' WHERE pendi_id='$pendi_id'";
    ...
    $query = "UPDATE pendi SET nama_divisi='$nama_divisi', koor='$koor', sekre='$sekre', benda='$benda', anggota_satu='$anggota_satu', anggota_dua='$anggota_dua', anggota_tiga='$anggota_tiga', anggota_empat='$anggota_empat', anggota_lima='$anggota_lima', anggota_enam='$anggota_enam' WHERE pendi_id='$pendi_id'";
    $result = mysqli_query($koneksi, $query);
