...
// Ambil nilai artikel_id dari parameter URL
$artikel_id = isset($_GET['id']) ? $_GET['id'] : null;

// Pastikan artikel_id tidak kosong dan hanya berisi angka
if ($artikel_id && is_numeric($artikel_id)) {
    // Query untuk mengambil detail artikel berdasarkan artikel_id
    $query = "SELECT * FROM artikel WHERE artikel_id = $artikel_id";
...
?>
            ...
            <div class="p-4 flex items-center">
                ...
                <div class="text-slate-500">
                    ...
                    <div class="bg-blue-700 text-white px-3 py-1 w-fit mt-1 rounded-2xl"><?= $artikel['tanggal_upload'] ?></div>
                </div>
            </div>
            <hr>
