...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "INSERT INTO inti (nama_divisi, ketua, wakil, sekre_satu, sekre_dua, benda_satu, benda_dua, img) VALUES ('$nama_divisi', '$ketua', '$wakil', '$sekre_satu', '$sekre_dua', '$benda_satu', '$benda_dua', '$new_image_name')";
