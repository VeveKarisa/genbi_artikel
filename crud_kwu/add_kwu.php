...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "INSERT INTO kwu (nama_divisi, koor, sekre, benda, anggota_satu, anggota_dua, anggota_tiga, anggota_empat, anggota_lima, anggota_enam, img) VALUES ('$nama_divisi', '$koor', '$sekre', '$benda', '$anggota_satu', '$anggota_dua', '$anggota_tiga', '$anggota_empat', '$anggota_lima', '$anggota_enam', '$new_image_name')";
    ...
    $query = "INSERT INTO kwu (nama_divisi, koor, sekre, benda, anggota_satu, anggota_dua, anggota_tiga, anggota_empat, anggota_lima, anggota_enam, benda_dua, img) VALUES ('$nama_divisi', '$koor', '$sekre', '$benda', '$anggota_satu', '$anggota_dua', '$anggota_tiga', '$anggota_empat', '$anggota_lima', '$anggota_enam', '$new_image_name')";
    $result = mysqli_query($koneksi, $query);
