...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "UPDATE kwu SET nama_divisi='$nama_divisi', koor='$koor', sekre='$sekre', benda='$benda', anggota_satu='$anggota_satu', anggota_dua='$anggota_dua', anggota_tiga='$anggota_tiga', anggota_empat='$anggota_empat', anggota_lima='$anggota_lima', anggota_enam='$anggota_enam', img='$new_image_name' WHERE kwu_id='$kwu_id'";
    ...
    $query = "UPDATE kwu SET nama_divisi='$nama_divisi', koor='$koor', sekre='$sekre', benda='$benda', anggota_satu='$anggota_satu', anggota_dua='$anggota_dua', anggota_tiga='$anggota_tiga', anggota_empat='$anggota_empat', anggota_lima='$anggota_lima', anggota_enam='$anggota_enam' WHERE kwu_id='$kwu_id'";
    $result = mysqli_query($koneksi, $query);
