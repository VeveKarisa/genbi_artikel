    ...
    <?php foreach ($result as $index => $row) : ?>
        <div class="p-4 flex gap-10 ">
            <div class="items-center w-3/4">
                ...
                <p class="mt-2  font-bold text-justify">Berikut adalah struktur keanggotaan Divisi Inti:</p>
                <li class="text-justify"><?= $row['ketua'] ?></li>
                <li class="text-justify"><?= $row['wakil'] ?></li>
                <li class="text-justify"><?= $row['sekre_satu'] ?></li>
                <li class="text-justify"><?= $row['sekre_dua'] ?></li>
                <li class="text-justify"><?= $row['benda_satu'] ?></li>
                <li class="text-justify"><?= $row['benda_dua'] ?></li>
            </div>
