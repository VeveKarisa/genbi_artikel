...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "INSERT INTO lh (nama_divisi, koor, sekre, benda, anggota_satu, anggota_dua, anggota_tiga, anggota_empat, anggota_lima, anggota_enam, anggota_tujuh, img) VALUES ('$nama_divisi', '$koor', '$sekre', '$benda', '$anggota_satu', '$anggota_dua', '$anggota_tiga', '$anggota_empat', '$anggota_lima', '$anggota_enam', '$anggota_tujuh', '$new_image_name')";
