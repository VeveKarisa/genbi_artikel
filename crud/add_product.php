...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "INSERT INTO artikel (judul, description, penulis, img, tanggal_upload) VALUES ('$judul', '$description', '$penulis', '$new_image_name', '$tanggal_upload')";
    ...
    $query = "INSERT INTO artikel (judul, description, penulis, img, tanggal_upload) VALUES ('$judul', '$description', null, '$tanggal_upload')";
    $result = mysqli_query($koneksi, $query);
