...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "UPDATE artikel SET judul='$judul', description='$description', penulis='$penulis', img='$new_image_name', tanggal_upload='$tanggal_upload' WHERE artikel_id='$artikel_id'";
    ...
    $query = "UPDATE artikel SET judul='$judul', description='$description', penulis='$penulis', tanggal_upload='$tanggal_upload' WHERE artikel_id='$artikel_id'";
    $result = mysqli_query($koneksi, $query);
