...
if ($image != '') {
    ...
    if (in_array($types, $allowed_type) === true) {
        ...
        $query = "INSERT INTO kesmas (nama_divisi, koor, sekre, benda, anggota_satu, anggota_dua, anggota_tiga, anggota_empat, anggota_lima, anggota_enam, img) VALUES ('$nama_divisi', '$koor', '$sekre', '$benda', '$anggota_satu', '$anggota_dua', '$anggota_tiga', '$anggota_empat', '$anggota_lima', '$anggota_enam', '$new_image_name')";
